    ...
    private static void makeCustomBow(Item item){
        ItemProperties.register(item, ResourceLocation.withDefaultNamespace("pull"), (ClampedItemPropertyFunction)((p_340951_, p_340952_, p_340953_, p_340954_) -> {
            if (p_340953_ == null) {
                ...
                boolean isUsing = p_340953_.getUseItem() == p_340951_;
        ...
        ItemProperties.register(item, ResourceLocation.withDefaultNamespace("pulling"), (ClampedItemPropertyFunction)((p_174630_, p_174631_, p_174632_, p_174633_) -> {
            boolean isPulling = p_174632_ != null && p_174632_.isUsingItem() && p_174632_.getUseItem() == p_174630_;
